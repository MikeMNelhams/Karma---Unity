...
public class BotTestAllPlayersNoActionsGameEnds : MonoBehaviour
{
    [UnitySetUp]
    ...
    public IEnumerator TestMain()
    {
        ...
        KarmaGameManager.Instance.SetSelectedBoardPreset(14);
        ...
        Assert.IsTrue(KarmaGameManager.Instance.SelectedKarmaPlayerMode.IsGameOverDueToNoLegalActions);
