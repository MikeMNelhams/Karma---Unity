...
public class BotTestJackOnNine : MonoBehaviour
{
    [UnitySetUp]
    ...
    public IEnumerator TestMain()
    {
        ...
        KarmaGameManager.Instance.SetSelectedBoardPreset(17);
        ...
        UnityEngine.Debug.Log("Current player index: " + KarmaGameManager.Instance.Board.CurrentPlayerIndex);

        Assert.IsTrue(KarmaGameManager.Instance.Board.CurrentPlayerIndex == 1);
