...
{
    public class SingleplayerManyStateMachine : StateMachine<State, Command>
    {
        protected PlayerHandler _playerProperties;

        public SingleplayerManyStateMachine(PlayerHandler playerProperties)
        {
        ...
        public SingleplayerManyStateMachine(State startState, PlayerHandler playerProperties) : this(playerProperties) { CurrentState = startState; }
    }
}