...
public class KarmaPlayerModeSelectorDrawer : PropertyDrawer
{
    ...
    protected string[] _presetOptionsSingleplayer = new string[10] { "TestStartQueenCombo", "TestStartJokerCombo", "TestStartVoting", "TestStartVoting2", "TestScenarioFullHand", "TestLeftwardsHandRotate", "TestGameWonNoVote", "TestPotentialWinnerIsSkippedInUnwonGame", "TestRandomStart", "RandomStart4"};
